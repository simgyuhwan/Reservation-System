...
#### [1. Event 설계](#1-event-설계)

##### [1) 추상 클래스](#1-추상-클래스)

##### [2) 인터페이스 상속](#2-인터페이스-상속)

##### [3) 메시지 전달](#3-메시지-전달)

#### [2. Event 생성](#2-event-생성)

##### [첫 번째 시도(Mapper)](#첫-번째-시도-mapper)

##### [두 번째 시도(Factory method 패턴)](#두-번째-시도-factory-method-패턴)

##### [세 번재 시도(Builder 패턴)](#세-번재-시도builder-패턴)

##### [네 번재 시도(Builder & Strategy 패턴)](#네-번재-시도builder--strategy-패턴)
