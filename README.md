...
![Structure](./document/image/structure_v7.png)


# **2. 프로젝트**

## 프로젝트 개요
이 프로젝트는 MSA 기반의 온라인 공연 예약 서비스입니다. 최근 몇 년간 개발 트렌드 중 하나인 MSA에 대해서 상충하는 의견이 많습니다.
<br>
 많은 의견 속에서 경험해 보지 못하면 판단하지 말자는 제 생각과 함께 ‘실제로 MSA로 구현하면 과연 어떨까?’라는 의문으로 프로젝트를 시작했습니다. 구현 설계로는 EDA로 SAGA 패턴을 적용하여 구현하였습니다. 현재는 테스트 코드 추가와 기능 정리를 진행하고 있습니다. 
